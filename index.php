        ...
        <p><label>Estado:<select name="menu" required>
         ...
         <option>Baja California Sur</option>
          ...
          <p><label>Grado de Estudios: <input type="text" name="estudios" size="40" placeholder="Escriba Su Grado De Estudios" required></p>
             ...
             <button type="reset">
         <img src="tachas.webp" alt="imagen" width="32" height="32" style="vertical-align: middle">
         Borrar
       </button>
       
             <button>
         <img src="enviar 2.jpg" alt="imagen" width="32" height="32" style="vertical-align: middle">
         Enviar
       </button>
       </form>
